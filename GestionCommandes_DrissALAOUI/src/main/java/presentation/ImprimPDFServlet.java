...
@WebServlet(name = "ImprimPDFServlet", value = "/imprimerPDF")
public class ImprimPDFServlet extends HttpServlet {
	...
	public void report(OutputStream out) {
		try {
			...
			report.addColumn(Columns.column("Prix_total", "prix_total", DataTypes.stringType()));
			report.addColumn(Columns.column("Prix_unit", "prix_unit", DataTypes.stringType()));
